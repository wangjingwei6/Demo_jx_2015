...
public class SimpleListViewAndSwipViewActivity extends Activity {
...
//		  tintManager.setTintColor(getResources().getColor(R.color.baise));
	...
	private void initData() {
		...
		//创建适配器
		MySwipeAdaptetr mMySwipeAdaptetr = new MySwipeAdaptetr(SimpleListViewAndSwipViewActivity.this, dataList);
	...
	private void showMyDialog(int type) {
		...
		case TYPE_ONE:
			...
			final NormalListDialog normalDialog = new NormalListDialog(
					SimpleListViewAndSwipViewActivity.this, dialoglist);
		...
		case TYPE_TWO:
			...
			//只展示文字
			final NormalListDialog normaldialog   = new NormalListDialog(SimpleListViewAndSwipViewActivity.this,dialoglist2);
			...
			//设置数据
			 ...
			 holder.content.setOnLongClickListener(new OnLongClickListener() {
				...
				public boolean onLongClick(View v) {
					...
					Utils.remindUserDialog(SimpleListViewAndSwipViewActivity.this, "后悔了", "确定", "你确认删除?", new LoginDialogListenner() {
